    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 p-4">
          ...
          <div className="animate-fade-in">
            <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-100 shadow-inner">
              <p className="text-gray-700 mb-4 text-lg font-medium">
                Папа, я искренне сожалею о том, что не пришел вовремя на работу и подвёл тебя.
              </p>
              ...
              <p className="text-purple-700 font-medium">
                Ты самый лучший папа, и я очень тебя люблю! Спасибо за твоё терпение и понимание. Обещаю исправиться и больше не опаздывать.
              </p>
            </div>
      ...
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl w-full">
        <ApologyCard 
          ...
          icon="😔" 
          description="Опоздание на работу было безответственным поступком. Я понимаю, почему ты расстроился, и как это повлияло на наши отношения."
        ...
        <ApologyCard 
          title="Благодарность" 
          icon="🙏" 
          description="Спасибо за то, что ты мой папа. Я ценю возможность работать с тобой и не хочу подводить тебя снова."
